...
CREATE TABLE product_tags(product_tag_id INT PRIMARY KEY NOT NULL auto_increment, product_id INT, tag VARCHAR(64));
CREATE TABLE equipment(equipment_id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, product_id INT, customer_id INT, serial_number VARCHAR(64), eve_id VARCHAR(64), is_rental BOOLEAN);
...
CREATE TABLE service_items(service_item_id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, service_id INT, equipment_id INT);

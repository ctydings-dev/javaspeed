...
CREATE TABLE customers(customer_id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, customer_key VARCHAR(64), customer_code  VARCHAR(128),  first_name VARCHAR(64), last_name VARCHAR(64), street VARCHAR(128), city VARCHAR(64), state VARCHAR(64), country VARCHAR(64), post_code VARCHAR(64), email VARCHAR(64), phone VARCHAR(32), date_of_birth datetime, eve_id varchar(32));
